...
def cmd_fan(args):
    # Connectivity to Ellie's register fan disabled at AJ's request (2026-07-05) — device was
    # being a problem. Body commented out below; restore by uncommenting to re-enable.
    return "Ellie's register fan control is disabled (commented out per AJ, 2026-07-05)."
